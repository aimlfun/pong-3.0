...
namespace Pong
{
    ...
    internal static class Digit
    {
        ...
        {
            if (i < 0 || i > 9) throw new ArgumentOutOfRangeException("This fetches an image of a digit 0..9");
        ...
        internal static Bitmap DigitAsBitmap(int digit)
        {
            ...
            const int c_pixelSize = 5;

            Bitmap bitmap = new(3 * c_pixelSize, 5 * c_pixelSize);
            ...
            for (int y = 0; y < 5; y++)
            {
                ...
                for (int x = 0; x < 3; x++)
                {
                    ...
                    {
                        graphics.FillRectangle(brushGrey, x * c_pixelSize, y * c_pixelSize, c_pixelSize, c_pixelSize);
                    }
                }
            }
